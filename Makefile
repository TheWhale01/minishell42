...
CFILES=$(addprefix $(SRC_DIR), exec.c exec_utils.c expander.c format.c lexer.c main.c pipe.c \
	prompt.c redirs_utils.c redirs.c token.c utils.c builtins/exit.c builtins/export.c \
	builtins/env.c builtins/aff_export.c builtins/cd.c builtins/echo.c builtins/pwd.c \
	builtins/unset.c)
