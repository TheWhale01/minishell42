...
CFILES=$(addprefix $(SRC_DIR), expander.c format.c lexer.c main.c redirs.c tmp.c token.c utils.c \
	builtins/exit.c builtins/export.c builtins/env.c builtins/aff_export.c builtins/echo.c)
